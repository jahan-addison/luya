...
Box2D Lite is a minimal, rigid-body physics engine originally written by Erin Catto as a companion to his GDC 2006 presentation. It implements sequential impulse-based constraint solving over a fixed timestep with contact caching, making it small enough and well-suited to heavy modification for embedded devices.
